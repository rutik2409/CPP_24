...
int main(void)
{
    ...
    cout << "main():Making use of object '_rs' to make a call to Date::show()" << endl;
    cout << "main():Address of object '_rs' is:" << &d1_rs << endl;
    d1_rs.show(); // == Date::show(&_rs); // formal parameter will be 'this' pointer
